...
public class ProjectActivity extends Activity implements IXListViewListener {
    private static final String DIS_DATE[] = {"全部分类", "居住景观", "商业办公", "城市绿地", "校园规划", "休闲度假", "滨水生态"};
    private static final String CLASS_DATE[] = {"全部区域", "入口景观", "场地节点", "园路栈桥", "水景泳池", "宅间入户", "庭院露台", "架空层", "景观建筑"};
    ...
    public void initResourceRefs() {
        ...
        showList.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                viewWidth = showList.getWidth();
                showList.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                onRefresh();
    ...
    public void initSetting() {
        ...
        claSpi.setOnItemSelectedListener(new OnItemSelectedListener() {
        ...
        awaySpi.setOnItemSelectedListener(new OnItemSelectedListener() {
        ...
        showList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent picIntent = new Intent(ProjectActivity.this, ProjectDetailActivity.class);
    ...
    public class NearAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holdview.name = (TextView) convertView.findViewById(R.id.listItemName);
                holdview.plantImage = (ImageView) convertView.findViewById(R.id.imageView1);
    ...
    private int getPlantList() {
        ...
        JSONObject get = NetManager.getInstance().sendHttpRequest("item/search", tt, HttpMethod.GET);
        try {
            if (get != null) {
    ...
    Handler dandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    Toast.makeText(_plant, "网络连接超时", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(_plant, "网络错误", Toast.LENGTH_SHORT).show();
                    break;
                case -9000:
                    Toast.makeText(_plant, "没有查到数据", Toast.LENGTH_SHORT).show();
