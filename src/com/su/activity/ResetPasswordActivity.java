        ...
        mLogin.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (oldpassword.trim().length() <= 0) {
                    Toast.makeText(reset, "旧密码不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (newpassword.trim().length() <= 0) {
                    Toast.makeText(reset, "新密码不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                JSONObject get = NetManager.getInstance().sendHttpRequest("account/reset_passwd", tt, HttpMethod.POST);
                if (get == null) {
                ...
                try {
                    ...
                    if (code != 200) {
                        Toast.makeText(reset, get.getString("message"), Toast.LENGTH_SHORT).show();
                        return;
                    }
