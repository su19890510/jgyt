...
public class MyPublishTaskActivity extends Activity implements OnClickListener, IXListViewListener {
    ...
    public void initSetting() {
        ...
        showList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent picIntent = new Intent(MyPublishTaskActivity.this, MyPublishTaskDetailActivity.class);
    ...
    public class NearAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                LayoutInflater inflater = LayoutInflater.from(MyPublishTaskActivity.this);
                convertView = inflater.inflate(R.layout.task_list_item, null);
                holdview = new HoldView();
                holdview.title = (TextView) convertView.findViewById(R.id.task_list_item_title);
                holdview.money = (TextView) convertView.findViewById(R.id.task_list_item_money);
                holdview.compant = (TextView) convertView.findViewById(R.id.task_list_item_company);
    ...
    private int getPlantList() {
        ...
        JSONObject get = NetManager.getInstance().sendHttpRequest("task/my_publish_task", tt, HttpMethod.GET);
        try {
            if (get != null) {
    ...
    Handler dandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    Toast.makeText(_task, "网络连接超时", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(_task, "网络错误", Toast.LENGTH_SHORT).show();
                    break;
                case -9000:
                    Toast.makeText(_task, "没有查到数据", Toast.LENGTH_SHORT).show();
